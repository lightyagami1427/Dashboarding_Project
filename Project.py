...
def main():
    ...
    with st.expander("Add Lift Data"):
        ...
        question_4 = st.number_input("Enter Body Weight After Workout")
        st.write('You selected:', question_4)
    
    

        if st.button("Submit New Results"):
            #create_table()
    ...
    st.sidebar.image("https://cutmap.ac.in/wp-content/uploads/Centurion-University-AP-logo.webp", width = 150)
